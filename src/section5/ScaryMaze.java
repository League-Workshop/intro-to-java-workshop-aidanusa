...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		maze = ImageIO.read(getClass().getResource("TheMaze.jpg"));
	...
	public void mouseMoved(MouseEvent e) {
		...
		if (mouseColor == -131072) {
			...
			JOptionPane.showMessageDialog(null, "Congratulations, You finished the maze.");
			System.exit(0);
		}
	...
	private void showScaryImage(String imageName) {
		try {
			maze = ImageIO.read(getClass().getResource("ScaryImage.jpg"));
		} catch (Exception e) {
