...
public class RobotTreasureHunt implements KeyEventDispatcher {
	...
	private void spaceBarWasPressed() {
		...
		int robotXLocation = r.getX();
		int robotYLocation = r.getY();
		...
		if (robotXLocation == 720) {
			if (robotYLocation == 420) {
				JOptionPane.showMessageDialog(null, "Go find the pirate flag.");
			}
		}
		if (robotXLocation == 450) {
			if (robotYLocation == 160) {
				JOptionPane.showMessageDialog(null, "Go find the cannon.");
			}
		}
